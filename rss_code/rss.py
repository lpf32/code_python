...
class SubjectTrigger(TitleTrigger):
    def __init__(self, word):
        WordTrigger.__init__(self, word)
...
class SummaryTrigger(TitleTrigger):
    def __init__(self, word):
        WordTrigger.__init__(self, word)
...
class PhraseTrigger(Triggers):
    def __init__(self, phrase):
        self.phrase = phrase

    def evaluate(self, story):
        return self.phrase in story.getSummary() or self.phrase in story.getSubject() \
...
def main_thread(master):
    ...
    try:
        ...
        while True:
            ...
            stories = process("http://rss.news.yahoo.com/rss/topstories")
